...
import com.spamguard.app.data.api.FcmTokenRequest
import com.spamguard.app.data.api.RetrofitClient
import com.spamguard.app.ui.WalletActivity
import kotlinx.coroutines.CoroutineScope
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.launch

class SpamGuardFirebaseService : FirebaseMessagingService() {

    companion object {
        const val CHANNEL_ID = "spamguard_push"
    }
    ...
    private fun ensureChannel(nm: NotificationManager) {
        ...
        nm.createNotificationChannel(
            NotificationChannel(CHANNEL_ID, "SpamGuard 알림", NotificationManager.IMPORTANCE_DEFAULT).apply {
